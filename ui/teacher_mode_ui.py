...
"}")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("c:\\Users\\Ada\\Desktop\\github\\re-lego\\ui\\icon/menu_bar.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("c:\\Users\\Ada\\Desktop\\github\\re-lego\\ui\\icon/min_window.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("c:\\Users\\Ada\\Desktop\\github\\re-lego\\ui\\icon/open_in_full_window.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("c:\\Users\\Ada\\Desktop\\github\\re-lego\\ui\\icon/close_window.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"}")
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("c:\\Users\\Ada\\Desktop\\github\\re-lego\\ui\\../../../../Downloads/home_50dp_000000_FILL0_wght400_GRAD0_opsz48.svg"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("c:\\Users\\Ada\\Desktop\\github\\re-lego\\ui\\icon/contact_page.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("c:\\Users\\Ada\\Desktop\\github\\re-lego\\ui\\icon/analytics.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("c:\\Users\\Ada\\Desktop\\github\\re-lego\\ui\\icon/settings.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("c:\\Users\\Ada\\Desktop\\github\\re-lego\\ui\\icon/new_releases.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"}")
        ...
        self.page_main = QtWidgets.QWidget(parent=self.main_window)
        ...
        self.stack_change_page = QtWidgets.QStackedWidget(parent=self.page_main)
...
"}")
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("c:\\Users\\Ada\\Desktop\\github\\re-lego\\ui\\icon/person_add.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"}")
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("c:\\Users\\Ada\\Desktop\\github\\re-lego\\ui\\icon/import_excel.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"}")
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("c:\\Users\\Ada\\Desktop\\github\\re-lego\\ui\\icon/import_qr_code.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.btn_filter = QtWidgets.QToolButton(parent=self.widget)
        self.btn_filter.setStyleSheet("\n"
"QToolButton {\n"
"    border: none; /* 去掉邊框 */\n"
"}")
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap("c:\\Users\\Ada\\Desktop\\github\\re-lego\\ui\\icon/filter_alt.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"")
        ...
        self.icon_create_data.setPixmap(QtGui.QPixmap("c:\\Users\\Ada\\Desktop\\github\\re-lego\\ui\\icon/account.png"))
        ...
        self.input_sex = QtWidgets.QComboBox(parent=self.page_create_new_data)
        ...
        self.input_class = QtWidgets.QLineEdit(parent=self.page_create_new_data)
        ...
        self.input_class.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        self.input_class.setObjectName("input_class")
        self.verticalLayout_4.addWidget(self.input_class)
        self.input_seat_number = QtWidgets.QLineEdit(parent=self.page_create_new_data)
        ...
        self.input_seat_number.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        self.input_seat_number.setObjectName("input_seat_number")
        self.verticalLayout_4.addWidget(self.input_seat_number)
        self.input_name = QtWidgets.QLineEdit(parent=self.page_create_new_data)
        ...
        self.input_name.setLayoutDirection(QtCore.Qt.LayoutDirection.LeftToRight)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap("c:\\Users\\Ada\\Desktop\\github\\re-lego\\ui\\icon/delete.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        spacerItem17 = QtWidgets.QSpacerItem(40, 10, QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Minimum)
        self.horizontalLayout_11.addItem(spacerItem17)
        self.btn_save = QtWidgets.QToolButton(parent=self.page_create_new_data)
        icon14 = QtGui.QIcon()
        icon14.addPixmap(QtGui.QPixmap("c:\\Users\\Ada\\Desktop\\github\\re-lego\\ui\\icon/save.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        spacerItem18 = QtWidgets.QSpacerItem(20, 50, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Fixed)
        ...
        self.icon_create_file.setPixmap(QtGui.QPixmap("c:\\Users\\Ada\\Desktop\\github\\re-lego\\ui\\icon/edit.png"))
        ...
        self.label_2 = QtWidgets.QLabel(parent=self.page_analytic)
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        ...
        self.label_3 = QtWidgets.QLabel(parent=self.page_setting)
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
        ...
        self.label_5 = QtWidgets.QLabel(parent=self.page_home)
        font = QtGui.QFont()
        font.setFamily("AniMe Matrix - MB_EN")
        font.setPointSize(14)
        ...
        self.label_4 = QtWidgets.QLabel(parent=self.page_release)
        font = QtGui.QFont()
        font.setFamily("微軟正黑體")
